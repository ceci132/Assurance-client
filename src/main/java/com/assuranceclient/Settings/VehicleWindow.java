 ...
 */
public class VehicleWindow extends javax.swing.JInternalFrame {
    ...
    private Vehicle currentItem = new Vehicle();

    /**
     * Creates new form VehiclesWindow
     *
     * @param token
     * @param parent
     */
    public VehicleWindow(String token, javax.swing.JFrame parent) {
        initComponents();
        this.token = token;
        beginWindow();
    }
    ...
    private void initComponents() {
        ...
        ieRegNomer = new javax.swing.JTextField();

        setTitle("Транспортни средства");
        ...
        jLabel2.setText("Транспортни средства");
        ...
        jPanel6.add(ieMname, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 144, 20));

        jLabel1.setText("Марка, модел");
        jPanel6.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, -1, 20));

        jLabel3.setText("Рег. номер");
        jPanel6.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 35, -1, 20));
        jPanel6.add(ieRegNomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 35, 144, 20));
    ...
    private void ipInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ipInsertActionPerformed
        ...
        try {
            saveVehicle("http://localhost:8080/api/vehicle", currentItem);
    ...
    private void ipModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ipModifyActionPerformed
        ...
        try {
            updateVehicle("http://localhost:8080/api/vehicle/" + currentItem.ids, currentItem);
    ...
    private void ipDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ipDelActionPerformed
        try {
            deleteVehicle("http://localhost:8080/api/vehicle/" + currentItem.ids);
    ...
    private void getFromForm(Vehicle tmp) {
        tmp.mname = ieMname.getText().trim();
        tmp.reg_num = ieRegNomer.getText().trim();
    }

    private void initVehicles() {

        try {
            jsonStringVehicles = getVehicles("http://localhost:8080/api/vehicles");
        } catch (Exception ex) {
            Logger.getLogger(VehicleWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            data = objectMapper.readValue(jsonStringVehicles, new TypeReference<ArrayList<Vehicle>>() {
            });
    ...
    private void showData() {
        ieMname.setText(currentItem.mname);
        ieRegNomer.setText(currentItem.reg_num);
    }
    ...
    private javax.swing.JTextField ieRegNomer;
    ...
    private String getVehicles(String uri) throws Exception {
    ...
    private String saveVehicle(String uri, Vehicle vehicle) throws Exception {
        ObjectWriter ow = new ObjectMapper().writer().withDefaultPrettyPrinter();
        String json = ow.writeValueAsString(vehicle);
    ...
    private void updateVehicle(String uri, Vehicle vehicle) throws Exception {
        ObjectWriter ow = new ObjectMapper().writer().withDefaultPrettyPrinter();
        String json = ow.writeValueAsString(vehicle);
    ...
    private String deleteVehicle(String uri) throws Exception {
        HttpClient client = HttpClient.newHttpClient();
