 ...
 */
public class TarifiWindow extends javax.swing.JInternalFrame {
    ...
    private ArrayList<Tarifa> data = new ArrayList();
    private Tarifa currentItem = new Tarifa();

    /**
     * Creates new form TarifasWindow
     *
     * @param token
     * @param parent
     */
    public TarifiWindow(String token, javax.swing.JFrame parent) {
        initComponents();
        this.token = token;
        beginWindow();
    }
    ...
    private void initComponents() {
        ...
        icTipMPS = new javax.swing.JTextField();
        ...
        jPanel6.add(icTipMPS, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 144, 20));

        jLabel1.setText("Тип МПС");
        jPanel6.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, -1, 20));

        jLabel3.setText("Стандартна цена");
        jPanel6.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 35, -1, 20));

        ieCena.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));
        jPanel6.add(ieCena, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 35, 90, -1));
    ...
    private void ipInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ipInsertActionPerformed
        ...
        try {
            savePrice("http://localhost:8080/api/price", currentItem);
    ...
    private void ipModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ipModifyActionPerformed
        ...
        try {
            updatePrice("http://localhost:8080/api/price/" + currentItem.ids, currentItem);
    ...
    private void ipDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ipDelActionPerformed
        try {
            deletePrice("http://localhost:8080/api/price/" + currentItem.ids);
    ...
    private void getFromForm(Tarifa tmp) {
        tmp.mname = icTipMPS.getText().trim();
    ...
    private void initTarifas() {
        ...
        try {
            jsonStringTarifas = getPrices("http://localhost:8080/api/prices");
        } catch (Exception ex) {
            Logger.getLogger(TarifiWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            data = objectMapper.readValue(jsonStringTarifas, new TypeReference<ArrayList<Tarifa>>() {
            });
    ...
    private void showData() {
        icTipMPS.setText(currentItem.mname);
        ieCena.setValue(currentItem.price);
    }
    ...
    private javax.swing.JTextField icTipMPS;
    ...
    private String getPrices(String uri) throws Exception {
    ...
    private String savePrice(String uri, Tarifa Tarifa) throws Exception {
        ObjectWriter ow = new ObjectMapper().writer().withDefaultPrettyPrinter();
        String json = ow.writeValueAsString(Tarifa);
    ...
    private void updatePrice(String uri, Tarifa Tarifa) throws Exception {
        ObjectWriter ow = new ObjectMapper().writer().withDefaultPrettyPrinter();
        String json = ow.writeValueAsString(Tarifa);
    ...
    private String deletePrice(String uri) throws Exception {
        HttpClient client = HttpClient.newHttpClient();
